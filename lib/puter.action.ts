...
import {getCreateHostingConfig, uploadImageToHosting} from "./puter.hosting";
...
export const createProject = async ({item, visibility = "private" }: CreateProjectParams): Promise<DesignItem | null | undefined>=>{
    ...
    const hosting = await getCreateHostingConfig();
    ...
    if(!resolvedSource){
        console.warn('failed to host source image, skiping save.')
        return null;
    }
